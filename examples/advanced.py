...
def main():
    instance = AiEthicsSimulator(config={
        "timeout": 30,
        "retries": 3,
        "debug": True,
    })

    print("=== Advanced ai-ethics-simulator Example ===\n")

    # Batch processing
    inputs = [f"data_{i}" for i in range(10)]
    results = [instance.analyze(input=inp, index=i) for i, inp in enumerate(inputs)]
